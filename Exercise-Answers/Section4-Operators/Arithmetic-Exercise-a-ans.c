...
{ 
    ...
    */
    ...
    printf("Air Force birthday year: %d\n", ((nineteen * hunnit) + fortySeven));
    printf("Army/Marines/Navy birthday year: %d\n", seventeen + (three * Quater));
    printf("Coast Guard birthday year: %d\n", seventeen + (ten * (ten-uno)));
